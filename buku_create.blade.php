    ...
    <div class="container-fluid page-body-wrapper">
      ...
      <form action="{{ route('buku.store') }}" method="POST">
          ...
          <div class="mb-3">
              ...
              <input type="text" id="judul" name="judul" value="{{ old('judul') }}" required class="form-control" placeholder="Masukkan Judul Buku">
          </div>

          <!-- Pengarang -->
          <div class="mb-3">
              <label for="pengarang" class="form-label">Pengarang</label>
              <input type="text" id="pengarang" name="pengarang" value="{{ old('pengarang') }}" required class="form-control" placeholder="Masukkan Nama Pengarang">
          </div>

          <!-- Penerbit -->
          <div class="mb-3">
              <label for="penerbit" class="form-label">Penerbit</label>
              <input type="text" id="penerbit" name="penerbit" value="{{ old('penerbit') }}" required class="form-control" placeholder="Masukkan Nama Penerbit">
          </div>

          <!-- Tahun Terbit -->
          <div class="mb-3">
              <label for="tahun_terbit" class="form-label">Tahun Terbit</label>
              <input type="number" id="tahun_terbit" name="tahun_terbit" value="{{ old('tahun_terbit') }}" required class="form-control" placeholder="Masukkan Tahun Terbit">
          </div>

          <!-- Keterangan -->
          <div class="mb-3">
              <label for="keterangan" class="form-label">Keterangan</label>
              <textarea id="keterangan" name="keterangan" class="form-control" placeholder="Masukkan Keterangan Buku">{{ old('keterangan') }}</textarea>
          </div>
